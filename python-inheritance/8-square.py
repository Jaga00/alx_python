...
class Square(Rectangle):
    ...
    def __init__(self, size):
        ...
        Raises:
            TypeError: Raised by integer_validator if size is not an integer.
            ValueError: Raised by integer_validator if size is less than or equal to 0.
        """
